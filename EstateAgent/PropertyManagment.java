...
public static String phoneNumber;
   private static void priceCheck()
   {
      ...
      {
         System.out.print("The price must contain numbers only, please re-enter");
      }
   }
      private static void phoneVal()
      {
         Scanner sc = new Scanner(System.in);
             ...
             case '4':
                ...
                do
                {
                   ...
                   switch (menu)
                   {
                      ...
                      case 1:
                         phoneVal();
                         MyArray.getCurrent(2).setVendorContactNumber(phoneNumber);
                      ...
                      case 2:
                         priceCheck();
                         MyArray.getCurrent(2).setPrice(price);
